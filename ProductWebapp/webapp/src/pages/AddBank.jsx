...
export default function AddBank() {
  ...
  const handleSubmit = () => {
    axios.get("https://2430-171-78-178-71.in.ngrok.io/bank-service/bank/get").then(
      response => {
                        ...
                        <Grid container sx={{ margin: "10px" }}>
                          ...
                          <Grid item xs={12} >
                            <Box textAlign='center'>
                              <Button onClick={handleSubmit} variant="contained" style={{ backgroundColor: "#005555" }} type="submit">
                                Add Account
                              </Button>
                            </Box>
                          </Grid>
