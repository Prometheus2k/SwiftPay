...
public class SwiftOperation {
    ...
    public String generateMT103FromMT101(String message) throws IOException {
        ...
        mt103.addField(new Field59A(mt101.getField59F().get(0).getNameAndAddress1()));
    ...
    public String generateMT910FromMT103(String message) throws IOException {
        ...
        mt910.addField(new Field25A(mt103.getReceiver()));
        mt103.addField(new Field32A().setDate(mt103.getField32A().getDate())
